...
public class PathFinder : MonoBehaviour
{
    ...
    {        
        ...
        startCoordinates = gridManager.GetCoordinatesFromPosition(start.transform.position);
        destinationCoordinates = gridManager.GetCoordinatesFromPosition(target.transform.position);
        if (gridManager != null)
        {
